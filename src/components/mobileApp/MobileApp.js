...
const MobileApp = () => {
    return (
        <div className='container mx-auto my-10'>
            <div className="bg-purple-700 flex flex-col sm:flex-row items-center sm:pl-12 justify-between rounded-lg">
                <div className="text-white p-5 text-center sm:text-left">
                    ...
                    <div className="grid sm:flex grid-cols-2 gap-2 my-4 sm:my-8">
                        <a href="#">
                            <img
